...
class Dota1024:
    ...
    def get_loaders(self, parse_patches=True, validation='dota'):
        ...
        train_dataset = Dota1024Dataset(dir=os.path.join(self.config.data.data_dir, 'data', 'dota_1024', 'val_split'),
...
class Dota1024Dataset(torch.utils.data.Dataset):
    def __init__(self, dir, patch_size, n, transforms, filelist=None, parse_patches=True, reverse_img=False):
        ...
        if filelist is None:
            ...
            dota_inputs = os.path.join(dota1024_dir, 'images')
            ...
            gt_names += [os.path.join(os.path.join(dota1024_dir, 'images'), i)
                         for i in images]
